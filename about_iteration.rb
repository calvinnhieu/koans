...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Evaluates the block for every element in the array including the injected value and the previous evaluation result
  end
  ...
  #   # code to read 'file'
  #
  # Leverage yield syntax
  # Behaves as a context manager i.e. auto closes resource?
  #
