...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Enable non-destructive override functionality of send.
  end
  ...
  # TL;DR use send to dynamically set the receiver.
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # It overrides the Object's error handling for all missing method invocations.
    #
    # NOTE:
    #
